...
const Listing = () => {
  ...
  // search filter using header's search query
    ...
    <div className='bg-primary'>
      <div className='max-padd-container !px-0 mt-18 pb-16'>
        ...
        <div className='flex flex-col sm:flex-row gap-6'>
          ...
          <div className="min-w-72 bg-white p-4 pl-6 lg:pl-12 rounded-r-xl my-4">
            ...
            <div className='py-3'>
              ...
              <select
                ...
                className='bg-primary ring-1 ring-slate-900/10 outline-none text-sm font-semibold text-gray-500 h-8 w-full rounded px-2'
              >
            ...
            <div className='p-5 mt-5 bg-primary rounded-xl'>
              ...
              {bodyType.map((type) => (
                <label
                  key={type}
                  className="flex gap-2 text-sm font-semibold text-gray-500 mb-1"
                >
                  <input
                    type="checkbox"
          ...
          <div className='max-sm:px-10 sm:pr-10 bg-white p-4 rounded-xl my-4'>
