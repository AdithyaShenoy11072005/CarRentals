...
const Item = ({ car }) => { // ✅ capitalized
  ...
  const bgColor = colors[
    parseInt(car._id?.slice(-4) || "0", 16) % colors.length
  ]
  ...
  return (
    ...
    >
      ...
      <div className='flexBetween'>
        <h5 className='my-1 text-grey-50'>{car.bodyType}</h5>
        <div className='text-sm font-bold text-solid '>
            {currency}
            {car.price.sale}|{currency}{car.price.rent}.00 <span 
